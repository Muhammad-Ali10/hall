    ...
    return (
        <div className='w-full bg-[url(/bg.jpg)] h-full 2xl:h-screen bg-cover bg-no-repeat bg-center bg-blend-overlay bg-[#212121]/80  grid grid-cols-1 md:grid-cols-2 items-center'>
            ...
            <div className='flex flex-col justify-center items-start max-w-[460px] p-10 bg-white rounded-md text-start gap-3 bottom-0'>
                <div>
                    <span className='font-poppins text-xs font-normal leading-5 text-black'>LET'S GET YOU STARTED</span>
                    <h3 className='font-poppins text-2xl font-medium leading-11 text-orange' >Create an Account</h3>
                </div>
                <form id='signUp-form' onSubmit={form.handleSubmit(onSubmit)} className='w-full '>
                    <FieldGroup className="gap-4">
                        <Controller
                            ...
                            render={({ field, fieldState }) => (
                                <Field data-invalid={fieldState.invalid}>
                                    <FieldLabel htmlFor="fullname" className="ml-4 -mb-6 z-10 bg-white !w-max font-poppins font-normal text-xs leading-5 text-gray">Full Name</FieldLabel>
                                    <Input id="fullname" type="text" className="h-16 border border-[#BDBDBD] font-poppins text-base text-gray" placeholder="Enter your full name" aria-invalid={fieldState.invalid}{...field} />
                                    {fieldState.invalid && (
                        ...
                        <Controller
                            ...
                            render={({ field, fieldState }) => (
                                <Field data-invalid={fieldState.invalid}>
                                    <FieldLabel htmlFor="password" className="ml-4 -mb-6 z-10 bg-white !w-max font-poppins font-normal text-xs leading-5 text-gray">Password</FieldLabel>
                                    <Input id="password" type="password" className="h-16 border border-[#BDBDBD] font-poppins text-base text-gray" placeholder="Enter your password" aria-invalid={fieldState.invalid} {...field} />
                                    {fieldState.invalid && (
                                        <FieldError errors={[fieldState.error]} />
                                    )}
                                </Field>
                    ...
                    <Button type="submit" className="font-poppins font-bold text-xs leading-5 mt-4 text-white bg-orange h-16 w-full" form="signUp-form">GET STARTED</Button>
                </form>
                ...
                <p className="font-poppins font-normal text-xs leading-5 text-black text-center mt-4">Already have an account? <span className="text-orange capitalize font-bold" >LOGIN HERE</span></p>
